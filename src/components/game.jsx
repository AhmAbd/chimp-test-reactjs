...
export default function Game() {
  ...
  let [currentLevel, setCurrentLevel] = React.useState(0);
  let [currentNumber, setCurrentNumber] = React.useState(0);
  ...
  function changeLevel(newLevel) {
    ...
    setInvisible(false);
    setCurrentNumber(1);
    store.setHighscore(Math.max(store.highscore, newLevel));
  }
